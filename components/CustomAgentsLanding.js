...
export default function CustomAgentsLanding() {
    ...
    return (
        <div ref={containerRef} className="bg-[#030014] min-h-screen text-white font-sans selection:bg-[#2f1f5c] overflow-x-clip">
            ...
            {/* Use Cases - Sticky & Alternating */}
            <section id="demo" className="py-32 bg-[#020205] border-t border-white/5 relative">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="flex flex-col lg:flex-row gap-24 items-start">
                        ...
                        {/* Right Side - Alternating Sticky Stack */}
                        <div className="lg:w-2/3 flex flex-col gap-24 pb-32 [--stack-top:100px] lg:[--stack-top:150px]">
                            {[
                                ...
                                <motion.div
                                    ...
                                    className={`sticky bg-[#0B0F19] border border-white/10 rounded-[2.5rem] p-8 md:p-12 overflow-hidden group shadow-2xl transition-all duration-500 ${caseStudy.borderColor}`}
                                    style={{ top: `calc(var(--stack-top, 100px) + ${idx * 30}px)`, zIndex: idx + 1 }}
                                >
                                    <div className="grid grid-cols-1 gap-8">
                                        <div className="relative h-[250px] md:h-[400px] rounded-2xl overflow-hidden border border-white/5 bg-[#020205]">
                                            <div className={`absolute inset-0 bg-gradient-to-br ${caseStudy.color}`}></div>
                                            <div className="absolute inset-0 flex items-center justify-center">
                                                {caseStudy.visual}
                                            </div>
                                        </div>
                                        <div>
                                            <h3 className={`text-3xl md:text-4xl font-bold mb-4 transition-colors ${caseStudy.titleColor}`}>{caseStudy.title}</h3>
