...
export default function VoiceAgentLanding({ data }) {
    ...
    return (
        <div ref={containerRef} className="bg-primary min-h-screen text-white font-sans selection:bg-sales-orange/30">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        <div className="inline-block bg-sales-red/10 text-sales-orange px-4 py-1.5 rounded-full text-sm font-medium mb-6 border border-sales-red/20 backdrop-blur-sm">
                            {data.heroBadge || "Cutting-Edge Voice AI"}
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-sales-orange to-sales-red">
                            {data.title.split(' for ')[1] || "Your Industry"}
                        </span>
                    </motion.h1>
                ...
                <section className="py-32 bg-secondary relative overflow-hidden">
                    <div className="container mx-auto px-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                            <div>
                                <h2 className="text-6xl md:text-8xl font-bold font-display tracking-tighter mb-8 leading-none text-white" dangerouslySetInnerHTML={{ __html: data.problem.title.replace(/\./g, '.<span class="text-sales-red"></span>') }}>
                                    {/* Content injected via dangeroulsySetInnerHTML to handle line breaks if needed, or structured differently */}
                                </h2>
                            </div>
            ...
            {/* Features - True Sticky Stacking (System Capabilities) */}
            {data.capabilities && (
                <section className="bg-primary relative pt-32 pb-48" id="features">
                    ...
                    <div className="relative">
                        {data.capabilities.map((feature, index) => (
                            <div
                                key={index}
                                ...
                                <div className="relative w-full max-w-6xl h-[70vh] bg-[#0B0F19] border border-white/10 rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row group">
                                    ...
                                    <div className="w-full md:w-1/2 p-12 md:p-16 flex flex-col justify-center relative z-10 bg-[#0B0F19]/80 backdrop-blur-md">
                                        ...
                                        <div className="grid gap-4">
                                            {feature.points && feature.points.map((point, i) => (
                ...
                <section className="py-32 bg-secondary text-white relative">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        <p className="text-xl text-white/60 max-w-2xl mx-auto mb-20">
                            We don't replace your tech stack. We supercharge it. SyncFlo integrates seamlessly with your existing platforms.
                        </p>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                            {data.integrations.map((item, idx) => (
                                <div key={idx} className="p-12 border border-white/10 hover:bg-white/5 transition-colors duration-500 group">
